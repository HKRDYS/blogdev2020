...
public interface IUserMapper {
    ...
    此注解中定义的userMap，后边可引用，如果配置了驼峰命名规则(或实体类与表字段名完全一致)，
    可省略,但要注意实体类与数据库表字段之间的严格对应关系，如login_name->loginName
     */
    ...
    public User findByLoginName(String loginName);//按照登陆名查询用户，用于登陆验证
